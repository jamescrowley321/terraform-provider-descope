...
- Type: `object` of `attributes.AccessKeyAttributeWidgetAuthorization`

Determines the permissions access key are required to have to access this attribute
...
AccessKeyAttributeWidgetAuthorization
=====================================
